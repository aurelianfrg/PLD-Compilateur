...
public:
  ...
  virtual std::any visitInstruction_def_stmt(
      ifccParser::Instruction_def_stmtContext *ctx) override;
  virtual std::any visitInstruction_return_stmt(
      ifccParser::Instruction_return_stmtContext *ctx) override;
  virtual std::any visitInstruction_if_stmt(
      ifccParser::Instruction_if_stmtContext *context) override;
  virtual std::any visitInstruction_while_stmt(
      ifccParser::Instruction_while_stmtContext *ctx) override;
  virtual std::any
  ...
  virtual std::any
  visitExpr_comp(ifccParser::Expr_compContext *context) override;
  virtual std::any
  visitExpr_eq_diff(ifccParser::Expr_eq_diffContext *context) override;
  ...
  virtual std::any
  visitExpr_minus_not(ifccParser::Expr_minus_notContext *ctx) override;
  virtual std::any
  visitExpr_add_sub(ifccParser::Expr_add_subContext *ctx) override;
  ...
  virtual std::any
  visitExpr_mult_div_mod(ifccParser::Expr_mult_div_modContext *ctx) override;
